...
- **[Hermes](#hermes)** — `SKILL.md` skills in `hermes/skills/agency/`
...
Agency agents are converted into Hermes skills with the `agency-` prefix and
installed under `~/.hermes/skills/agency/`.
